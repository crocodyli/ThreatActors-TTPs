...
| Privilege Escalation | Credential Dumping (T1003 / T1003.001 / T1003.002) | T1003 | Theft of credentials from **LSASS**, **SAM**, or **memory dumps** using tools like **Mimikatz**, **LaZagne**, and **DonPAPI**. |
| Privilege Escalation | Kerberoasting (T1558.003 / T1550) | T1558.003 | Abuse of the **Kerberos** protocol to obtain service-account hashes for lateral escalation. |
...
| Defense Evasion | Living-off-the-Land Binaries (T1218 / T1059) | T1218 | Use of native Windows binaries such as **certutil**, **rundll32**, or **wmic** to execute and persist without dropping additional files. |
...
| Discovery | Network & System Discovery (T1016 / T1018 / T1046 / T1082) | T1016 | Network scanning and system mapping with **Advanced IP Scanner**, **LANsweeper**, **Masscan**, and **PCHunter64**. |
...
| Lateral Movement | Remote Services: RDP / SSH (T1021.001 / T1021.004) | T1021.001 | Use of **RDP**, **SSH**, and **Impacket** modules (**wmiexec.py**, **atexec.py**) for remote execution. |
| Lateral Movement | Lateral Tool Transfer | T1570 | Moving tools and payloads between systems for internal propagation. |
| Collection | Archive Collected Data (T1560 / T1560.001) | T1560 | Compression and staging of data using **7zip**, **WinRAR**, or **zip utilities** before exfiltration. |
| Command and Control | Web Service / Cloud Tunnel (T1071.004 / T1219) | T1071.004 | Persistent command-and-control via **Cloudflare Tunnel**, **Ngrok**, or remote admin tools. |
| Command and Control | Remote File Copy | T1105 | File staging and transfer using **rclone**, **scp**, or similar utilities. |
