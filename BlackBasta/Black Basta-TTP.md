...
|:---|:---|:---:|:---|
| Initial Access | Phishing | T1566 | The actors use spearphishing emails to gain initial access. |
| Initial Access | Spear Phishing Attachment | T1566.001 | Victims receive spear phishing emails with attached malicious   zip files - typically password protected. That contains malicious doc   including .doc, .pdf, .xls |
| Initial Access | Exploit Public-Facing Application | T1190 | Affiliates exploited various vulnerabilities for initial   access to organizations. |
